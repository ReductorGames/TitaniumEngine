...
import com.reductorgames.titaniumengine.textures.TextureData;
...
public class Loader {
    ...
    public RawModel loadToVAO(float[] positions, float[] texureCoordinates, float[] normals, int[] indices) {
        int vaoID = createVAO();
        bindIndicesBuffer(indices);
        vaos.add(vaoID);
        storeDataInAttributeList(0, 3, positions);
        storeDataInAttributeList(1, 2, texureCoordinates);
    ...
    public void cleanUp() {
        ...
        for (int texure:textures) {
            GL11.glDeleteTextures(texure);
        }
    }
